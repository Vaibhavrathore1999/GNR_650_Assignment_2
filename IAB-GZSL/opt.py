...
def get_opt():
    ...
    parser.add_argument('--att_size',type=int, default=300,help='size of the attribute')
    ...
    parser.add_argument('--seen_classes', type=int, default=25, help='number of seen classes')
